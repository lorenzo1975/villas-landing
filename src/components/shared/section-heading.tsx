  ...
  return (
    ...
    >
      {eyebrow ? (
        <span
          className={cn(
            "text-[0.7rem] font-semibold uppercase tracking-[0.15em] sm:tracking-[0.45em]",
      ...
      <h2 className="font-sans text-4xl leading-tight tracking-tight sm:text-5xl lg:text-6xl">
        {title}
      </h2>
      {description ? (
        <p
